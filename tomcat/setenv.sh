...
export OTEL_EXPORTER_OTLP_TRACES_ENDPOINT=http://otelcol-deployment-service:4318
export OTEL_EXPORTER_OTLP_METRICS_ENDPOINT=http://otelcol-deployment-service:4318
export OTEL_EXPORTER_OTLP_LOGS_ENDPOINT=http://otelcol-deployment-service:4318
